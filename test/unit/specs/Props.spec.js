...
describe('Props', () => {
  describe('allowClearingDisabled', () => {
    ...
    describe('when allowClearingDisabled=false', async () => {
      beforeEach(() => {
        wrapper.setProps({ allowClearingDisabled: false })
      })

      describe('when all selected nodes are disabled', async () => {
        beforeEach(() => {
      ...
      describe('when not all selected nodes are disabled', async () => {
        beforeEach(() => {
    ...
    describe('when allowClearingDisabled=true', async () => {
      beforeEach(() => {
  ...
  describe('allowSelectingDisabledDescendants', () => {
    ...
    describe('when allowSelectingDisabledDescendants=false', async () => {
      beforeEach(() => {
    ...
    describe('when allowSelectingDisabledDescendants=true', async () => {
      beforeEach(() => {
  ...
  describe('disableBranchNodes', () => {
    ...
    describe('when disableBranchNodes=false', async () => {
      beforeEach(() => {
  ...
  describe('valueConsistsOf', () => {
    ...
    describe('set value', () => {
      ...
      describe('when multiple=false', async () => {
        const types = [ ALL, BRANCH_PRIORITY, LEAF_PRIORITY, ALL_WITH_INDETERMINATE ]
        types.forEach(type => {
